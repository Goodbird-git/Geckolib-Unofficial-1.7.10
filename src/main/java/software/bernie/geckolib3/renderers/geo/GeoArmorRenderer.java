...
public abstract class GeoArmorRenderer<T extends ItemArmor & IAnimatable> extends ModelBiped
    ...
    public void render(float partialTicks) {
        ...
        if (isSneak) {
            ...
            try {
                ...
                rightLegBone.setPositionY(bodyBone.getPositionX() + 2F);
                leftLegBone.setPositionY(bodyBone.getPositionX() + 2F);
                rightBootBone.setPositionY(bodyBone.getPositionX() + 2F);
                leftBootBone.setPositionY(bodyBone.getPositionX() + 2F);
            } catch (Exception e) {
    ...
    public Integer getUniqueID(T animatable) {
        return Objects.hash(this.armorSlot, itemStack.getItem(), itemStack.stackSize,
